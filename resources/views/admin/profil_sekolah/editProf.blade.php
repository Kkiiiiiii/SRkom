...
@section('content')
    <div class="container my-5">
        ...
        @endif
        <form action="{{ route('admin.profilSek-update', Crypt::encrypt($profil->id_profil)) }}" method="POST"
            ...
            <div class="mt-3 mb-3">
                ...
                <input type="text" name="kepala_sekolah" class="form-control" id="kepala_sekolah"
                    value="{{ old('kepala_sekolah', $profil->kepala_sekolah) }}" required>
            </div>
            ...
            <div class="mt-3 mb-3">
                ...
                @if ($profil->logo)
                    <img src="{{ asset('storage/guru/' . $profil->logo) }}" alt="Logo Sekolah" width="150"
                        class="mb-2">
                    <br>
                @endif
            ...
            <div class="mt-3">
                <a href="{{ route('admin.profilSek') }}" class="btn btn-secondary">Batal</a>

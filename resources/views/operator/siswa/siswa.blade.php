...
@section('content')
    ...
    <section class="container my-5">
        ...
        <div class="table-responsive">
            <table class="table table-md table-secondary text-center align-middle" id="siswa">
                ...
                <tbody>
                    @foreach ($siswa as $item)
                        ...
                        <!-- Modal Edit Siswa -->
                        <div class="modal fade" id="editSiswaModal{{ $item->id_siswa }}" tabindex="-1"
                            aria-labelledby="editSiswaModalLabel{{ $item->id_siswa }}" aria-hidden="true">
                            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                <div class="modal-content">
                                    <form action="{{ route('operator.Siswa-update', $item->id_siswa) }}" method="POST">
                                        @csrf
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="editSiswaModalLabel{{ $item->id_siswa }}">Edit Data
                                                Siswa</h5>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                <label for="nisn{{ $item->id_siswa }}" class="form-label">NISN
                                                    Siswa</label>
                                                <input type="number" class="form-control" id="nisn{{ $item->id_siswa }}"
                                                    name="nisn" value="{{ $item->nisn }}" required>
                                            </div>

                                            <div class="mb-3">
                                                <label for="nama_siswa{{ $item->id_siswa }}" class="form-label">Nama
                                                    Siswa</label>
                                                <input type="text" class="form-control"
                                                    id="nama_siswa{{ $item->id_siswa }}" name="nama_siswa"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="radio" name="jenis_kelamin" value="Laki-laki"
                                                    {{ $item->jenis_kelamin == 'Laki-laki' ? 'checked' : '' }}> Laki-laki
                                                <input type="radio" name="jenis_kelamin" value="Perempuan"
                                                    {{ $item->jenis_kelamin == 'Perempuan' ? 'checked' : '' }}> Perempuan
                                            </div>

                                            <div class="mb-3">
                                                <label for="tahun_masuk{{ $item->id_siswa }}" class="form-label">Tahun
                                                    Masuk</label>
                                                <input type="number" class="form-control"
                                                    id="tahun_masuk{{ $item->id_siswa }}" name="tahun_masuk"
            ...
            {{-- Modal Tambah Siswa --}}
            <div class="modal fade" id="createSiswaModal" tabindex="-1" aria-labelledby="createSiswaModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-scrollable">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('operator.siswa-store') }}" method="POST"
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="year" class="form-control" id="tahun_masuk" name="tahun_masuk"
                                        required>
                                </div>
                        </div>
                        <div class="modal-footer">

...
<div class="container my-5">
    ...
    @endif
    <form action="{{ route('operator.Guru-update', Crypt::encrypt($guru->id_guru)) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('POST')
        ...
        <a href="{{ route('operator.Guru') }}" class="btn btn-secondary">Batal</a>

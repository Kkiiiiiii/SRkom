...
class profilSekolahController extends Controller
{
   ...
   public function create()
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('operator.profil')->with('success', 'Data berhasil disimpan!');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('operator.profil')->with('success', 'Data berhasil diperbarui!');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('operator.profil')->with('success', 'Data berhasil dihapus');
    }
